$(document).ready(function () {
  ...
  let tableRow = "";
  let table = "";
  function changeId(initialId, finalId) {
  ...
  document.querySelector("#add").addEventListener("click", function () {
    ...
    document.querySelector("#employee_number").value = "";
    document.querySelector("#religion").value = "";
    document.querySelector("#datejoined").value = "";
    document.querySelector("#employee_position").value = "";
    document.querySelector("#blood_group").value = "";
    document.querySelector("#employee_category").value = "";
    ...
    document.querySelector("#nextofkin_name").value = "";
    document.querySelector("#nextofkin_relationship").value = "";
    document.querySelector("#nextofkin_mobile_number").value = "";
    document.querySelector("#next_of_kin_address").value = "";
    ...
    document.querySelector("#employeeModalLabel").textContent =
      "Create Employee";
    // formMethod = "PUT";
  ...
  const getTableData = function (url) {
    table = $("table").DataTable({
      ...
      columns: [
          ...
          render: function (data, type, row, meta) {
            if (type === "display") {
              if (row.employee_number) {
                data = `<a class="dropdown-list-image" href="students?source=edit&id=${
                  row.user_id
                }"><img src="img/${
        ...
        // {
        //   data: "class_abbreviation",
        //   render: function (data, type, row, meta) {
        //     if (type === "display") {
        //       data = `${row.class_abbreviation} ${row.arm}`;
        //     }
        //     return data;
        //   },
        // },
  ...
  getTableData(
    `includes/fetchEmployeeData.php?status=${status}&&batch=${batch}`
  );

  // getTableData(
  //   `fetchEmployeeData?search_keywords=${search_keywords}&&status=${status}&&batch=${batch}`
  // );
