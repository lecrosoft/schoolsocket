...
class Guardian
{
    ...
    public static function fetchAllGuardian()
    {
        $sql = self::findThisQuery("SELECT * FROM user WHERE user_type = 'Guardian' AND status = 'Active' ");
        return $sql;
    }
    public static function fetchGuardianById($user_id)
    {
        global $db;
    ...
    public  function create()
    {
        ...
        if ($querySql) {
            ...
            $sql = self::fetchGuardianById($this->id);
