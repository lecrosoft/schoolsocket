        ...
        <div class="card  bg-gradient-danger shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="h5 mb-0 font-weight-bold text-white"><?php echo number_format($countEmployee) ?> </div>
                    ...
                    <div class="d-flex flex-column">
                        <div class="col mr-2 mb-2">
                            <div class="text-xs font-weight-bold text-success text-capitalize  mb-1">
                                Active Employee</div>
                            <div class="h5 mb-0 font-weight-bold text-white"><?php echo number_format($countActiveEmployee) ?></div>
                        </div>
                        <div class="col mr-2 mb-2">
                            <div class="text-xs font-weight text-white text-capitalize  mb-1">
                                Deactivated Employee</div>
                            <div class="h5 mb-0 font-weight-bold text-white"><?php echo number_format($countInActive_employee) ?></div>
                        </div>
                    </div>
                    <!-- <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo number_format($countMale_staff) ?></div>
                            </div>
                            <div class="col">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo number_format($countFemale_staff) ?></div>
                            </div>
                            <div class="col">
                                <div class="progress progress-sm mr-2">
